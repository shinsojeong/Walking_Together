...
public class AdminService {
    ...
    public List<ActivityInfoDTO> activityInfo(String keyword,
                                              LocalDate from,
                                              LocalDate to) {
        List<Tuple> tuples = activityRepository.activityInfo(keyword, from, to);
    ...
    // 파트너 정보 조회
    public List<PartnerInfoDTO> partnerInfo(String keyword, String partnerDivision) {

        List<Tuple> tuples = partnerRepository.partnerInfo(keyword, partnerDivision);
