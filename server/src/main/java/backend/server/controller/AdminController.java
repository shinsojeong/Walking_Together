...
public class AdminController {
                                           ...
                                           @RequestParam(value = "to") @Nullable String to)
    {
        ...
        List<ActivityInfoDTO> activityList = adminService.activityInfo(keyword, fromDate, toDate);
    ...
    public Map<String, Object> partnerInfo(@RequestParam(value = "keyword") @Nullable String keyword,
                                           @RequestParam(value = "partnerDivision") @Nullable String partnerDivision) {

        Map<String, Object> response = new HashMap<>();

        List<PartnerInfoDTO> partnerList = adminService.partnerInfo(keyword, partnerDivision);
