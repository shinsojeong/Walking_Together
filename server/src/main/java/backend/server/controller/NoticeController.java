...
import backend.server.DTO.notice.FileData;
...
public class NoticeController {
    ...
    public void uploadImage(@ModelAttribute FileData fileData)
...

    {
        ...
        if(fileData.getImageFiles() != null) {
            for (MultipartFile file : fileData.getImageFiles()) {
                fileUploadService.uploadImage(file, noticeId);
            }
        }

        if(fileData.getAttachedFiles() != null) {
            for (MultipartFile file : fileData.getAttachedFiles()) {
